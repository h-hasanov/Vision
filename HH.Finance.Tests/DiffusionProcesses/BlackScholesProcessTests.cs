...
{
    [TestFixture]
    internal sealed class BlackScholesProcessTests
    {
        private IBlackScholesProcess _sut;
        ...
        public void Setup()
        {
            _rate = 0.03;
            _volatility = 0.2;
            _sut = new BlackScholesProcess(_rate, _volatility);
        }
        ...
        public void Ctor_SetsParameters_Correctly()
        {
            ...
            //Act
            _sut = new BlackScholesProcess(rate, volatility);

            //Assert
            Assert.AreEqual(rate, _sut.Rate);
        ...
        {
            //Arrange
            const double expectedResult = 0.01d;

            //Act
            var result = _sut.Drift(default(double), default(double));
        ...
        public void Expectation_Returns_CorrectValue()
        {
            ...
            const double expectedResult = 0.0304;
        ...
        public void Variance_Returns_CorrectValue()
        {
            //Arrange
            const double dt = 0.04;
            const double expectedResult = 0.0016d;
