...
{
    public class DifusionProcessBase : IDiffusionProcess
    {
        #region Methods
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public virtual double Drift(double time, double x)
        {
            return 0;
        }
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public virtual double Diffusion(double t, double x)
        {
            return 0;
        }
        ...
        {
            var sigma = Diffusion(t0, x0);
            return sigma.Square() * dt;
        }
