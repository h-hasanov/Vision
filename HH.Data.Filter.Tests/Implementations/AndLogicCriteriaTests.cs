...
namespace HH.Data.Filter.Tests.Implementations
{
    ...
    internal sealed class AndLogicCriteriaTests
    {
        ...
        public void Setup()
        {
            ...
            _sut = new AndLogicCriteria<IPerson>(_firstCriteria, _secondCriteria);
        }
        ...
        public void MeetCriteria_Returns_Correctly()
        {
            ...
            //Assert
            CollectionAssert.AreEquivalent(new[] { personFour }, result);
        }
