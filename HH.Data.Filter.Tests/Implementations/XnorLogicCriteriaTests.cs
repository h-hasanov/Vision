...
namespace HH.Data.Filter.Tests.Implementations
{
    ...
    internal sealed class XnorLogicCriteriaTests
    {
        ...
        public void Setup()
        {
            ...
            _sut = new XnorLogicCriteria<IPerson>(_firstCriteria, _secondCriteria);
        }
        ...
        public void MeetCriteria_Returns_Correctly()
        {
            ...
            //Assert
            CollectionAssert.AreEquivalent(new[] { personOne, personFour }, result);
        }
