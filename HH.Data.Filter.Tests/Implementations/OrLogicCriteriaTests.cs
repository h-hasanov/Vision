...
namespace HH.Data.Filter.Tests.Implementations
{
    ...
    internal sealed class OrLogicCriteriaTests
    {
        ...
        public void Setup()
        {
            ...
            _sut = new OrLogicCriteria<IPerson>(_firstCriteria, _secondCriteria);
        }
        ...
        public void MeetCriteria_Returns_Correctly()
        {
            ...
            //The following will not be executed as first fails same for person4;
            ...
            //Assert
            CollectionAssert.AreEquivalent(new[] { personTwo, personThree, personFour }, result);
        }
