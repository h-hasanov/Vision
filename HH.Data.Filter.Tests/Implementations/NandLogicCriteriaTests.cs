...
namespace HH.Data.Filter.Tests.Implementations
{
    ...
    internal sealed class NandLogicCriteriaTests
    {
        ...
        public void Setup()
        {
            ...
            _sut = new NandLogicCriteria<IPerson>(_firstCriteria, _secondCriteria);
        }
        ...
        public void MeetsCriteria_Returns_Correctly(bool firstResult, bool secondResult, bool expectedOutcome)
        {
            ...
            if (firstResult) //not going to execute second if first fails;
        ...
        public void MeetCriteria_Returns_Correctly()
        {
            ...
            //The following will not be executed as first fails same for person 2.
            ...
            //Assert
            CollectionAssert.AreEquivalent(new[] { personOne, personTwo, personThree }, result);
        }
