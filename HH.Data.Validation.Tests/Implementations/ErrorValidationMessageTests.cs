...
{
    [TestFixture]
    internal sealed class ErrorValidationMessageTests
    {
        private AutoMocker _autoMocker;
        private IErrorValidationMessage _sut;
        ...
        public void Ctor_Sets_Properties()
        {
            ...
            //Act
            _sut = new ErrorValidationMessage(displayMessage);

            //Assert
            Assert.AreEqual(displayMessage, _sut.Text);
            Assert.AreEqual(MessageType.Error, _sut.MessageType);
        }
    }
}
